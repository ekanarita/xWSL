...
**INSTRUCTIONS:  From an elevated prompt, change to your desired install directory and type/paste the following command:**
    ...
    PowerShell -executionpolicy bypass -command "wget https://raw.githubusercontent.com/ekanarita/xWSL/focal/xWSL.cmd -UseBasicParsing -OutFile xWSL.cmd ; .\xWSL.cmd"
